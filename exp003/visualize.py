...
def visualize(im_input, im_output, pred, pred_motion, gt_motion, m_range, reverse_m_dict):
    img = visualize_image(im_input, im_output, pred, pred_motion, gt_motion, m_range, reverse_m_dict)
    plt.figure(1)
    plt.imshow(img)
    plt.axis('off')
    plt.show()
...
def visualize_image(im_input, im_output, pred, pred_motion, gt_motion, m_range, reverse_m_dict):
